  ...
  return (
    ...
    >
      {(field: any) => (
        ...
        >
          <div className="rounded-lg border bg-white shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-800">
            <div className="flex items-center justify-between border-b px-4 py-2.5 border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="rounded-md bg-blue-100 px-2.5 py-1.5 text-xs font-medium text-blue-700 transition-colors hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-900/50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1"
                ...
                <button
                  ...
                  className="rounded-md bg-blue-100 px-2.5 py-1.5 text-xs font-medium text-blue-700 transition-colors hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-900/50"
                  title="Set the current editor selection as the copy recommendation"
                >
                  Set Copy Range
                </button>
                <div className="hidden lg:flex items-center gap-0.5 rounded-md border bg-white p-0.5 border-gray-300 dark:border-gray-600 dark:bg-gray-700">
                  <button
                    type="button"
                    onClick={() => onViewModeChange('split')}
                    className={`rounded p-1.5 transition-all ${
                      viewMode === 'split'
                        ? 'bg-gray-200 text-gray-900 shadow-sm dark:bg-gray-600 dark:text-gray-100'
            ...
            <div className="h-[400px] lg:h-[500px] bg-white dark:bg-gray-900">
              <Editor
                height="100%"
                language="typst"
          ...
          <div className="rounded-lg border bg-white shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-800">
            <div className="border-b px-4 py-2.5 border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
              <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                Preview
              </h3>
            ...
            <div className="h-[400px] lg:h-[500px] bg-gray-50 dark:bg-gray-900">
